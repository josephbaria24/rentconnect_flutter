...
class PropertyService {
  ...
  Future<List<Property>> fetchProperties() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.31:3000/getAllProperties'));
  ...
  Future<void> fetchUserBookmarks(Function(List<String>) updateBookmarks) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.31:3000/getUserBookmarks/$userId'),
        headers: {
  ...
  Future<String> fetchUserEmail(String userId) async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.1.31:3000/getUserEmail/$userId'));
