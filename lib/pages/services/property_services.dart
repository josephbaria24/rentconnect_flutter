...
class PropertyService {
  ...
  Future<List<Property>> fetchProperties() async {
    try {
      final response = await http.get(Uri.parse('https://rentconnect-backend-nodejs.onrender.com/getAllProperties'));
  ...
  Future<void> fetchUserBookmarks(Function(List<String>) updateBookmarks) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://rentconnect-backend-nodejs.onrender.com/getUserBookmarks/$userId'),
        headers: {
  ...
  Future<String> fetchUserEmail(String userId) async {
    try {
      final response = await http
          .get(Uri.parse('https://rentconnect-backend-nodejs.onrender.com/getUserEmail/$userId'));
