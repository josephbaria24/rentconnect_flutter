...
class _RoomCreationPageState extends State<RoomCreationPage> {
  ...
  var request = http.MultipartRequest('POST', Uri.parse('http://192.168.1.17:3000/rooms/createRoom'));
  ...
  Future<void> _deleteProperty() async {
    try {
      final response = await http.delete(
        Uri.parse('http://192.168.1.17:3000/deleteProperty/${widget.propertyId}'),
      );
