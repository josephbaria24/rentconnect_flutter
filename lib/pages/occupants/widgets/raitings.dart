...
class _RatingWidgetState extends State<RatingWidget> {
  ...
  Future<void> _fetchExistingRating() async {
    final url = 'https://rentconnect.vercel.app/getRating/${widget.propertyId}/${widget.userId}'; // Assuming you have a route to get a user's rating for a property
  ...
  Future<void> _submitRating() async {
    final url = 'https://rentconnect.vercel.app/rateProperty/${widget.propertyId}';
  ...
  Future<void> _updateRating() async {
    final url = 'https://rentconnect.vercel.app/updateRating/${widget.propertyId}/${_existingRating!['_id']}'; // Update rating route
  ...
  Future<void> _deleteRating() async {
    final url = 'https://rentconnect.vercel.app/deleteRating/${widget.propertyId}/${_existingRating!['_id']}'; // Delete rating route
